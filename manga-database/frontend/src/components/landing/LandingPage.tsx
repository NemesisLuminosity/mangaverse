...
// Stable list of sample responses for the typing effect
const RESPONSES = [
  ...
  return (
    <div className="antialiased text-slate-100 bg-slate-950 min-h-screen">
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <header className="max-w-7xl mx-auto pt-6 px-6">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-8 text-sm text-slate-200/80 items-center">
              ...
              <button onClick={() => navigate('/register')} className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-white/10 hover:bg-white/20 ring-1 ring-white/20 rounded-lg transition">
                Start Reading
              </button>
            </nav>
        ...
        {/* Hero */}
        <section id="about" className="lg:pt-32 lg:pb-32 max-w-7xl mx-auto pt-24 px-6 pb-24">
            ...
            <div className="lg:col-span-7">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-12">
                  <button onClick={() => navigate('/dashboard')} className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-purple-500 hover:bg-purple-400 rounded-lg transition shadow-lg">
                    Explore Manga
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10">
                  ...
                  <div>
                    <div className="flex items-center gap-1" aria-label="4.9 out of 5 stars" title="4.9 out of 5">
                      <span className="text-2xl font-semibold text-white">4.9</span>
                      <Star className="h-5 w-5 text-yellow-400" strokeWidth={1.5} fill="currentColor" />
                    </div>
      ...
      <footer className="max-w-7xl mx-auto pt-20 px-6 pb-12">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="p-2 rounded-lg bg-white/5 ring-1 ring-white/10 hover:bg-white/10 transition">
                <Twitter className="h-5 w-5 text-slate-300" strokeWidth={1.5} />
              </a>
              <a href="https://github.com" target="_blank" rel="noreferrer" className="p-2 rounded-lg bg-white/5 ring-1 ring-white/10 hover:bg-white/10 transition">
                <Github className="h-5 w-5 text-slate-300" strokeWidth={1.5} />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-2 rounded-lg bg-white/5 ring-1 ring-white/10 hover:bg-white/10 transition">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300/80">
              ...
              <li>
                <a href="/#top-rated" className="hover:text-white transition">
                  Top Rated
                </a>
              </li>
              <li>
                <a href="/#new-releases" className="hover:text-white transition">
                  New Releases
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-400">© 2025 MangaVerse. All rights reserved.</p>
          <div className="flex items-center gap-6 text-sm text-slate-400">
            <span id="privacy" className="hover:text-white transition cursor-pointer">
              Privacy Policy
            </span>
            <span id="terms" className="hover:text-white transition cursor-pointer">
              Terms of Service
            </span>
            <span id="cookies" className="hover:text-white transition cursor-pointer">
              Cookie Policy
            </span>
          </div>
        </div>
